  ...
  return (
    <div className="bg-gray-800 text-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto pr-2 -mr-2">
        {/* Thông tin phim */}
        <div className="mb-6">
          <h3 className="text-xl font-semibold border-b border-gray-600 pb-2 mb-4">Thông tin vé</h3>
          <div className="space-y-2">
            <p><span className="font-medium">Phim:</span> {order.title || 'Chưa chọn'}</p>
            <p><span className="font-medium">Rạp:</span> {order.cinema || 'Chưa chọn'}</p>
            <p><span className="font-medium">Ngày:</span> {order.date || 'Chưa chọn'}</p>
            <p><span className="font-medium">Suất chiếu:</span> {order.showtime || 'Chưa chọn'}</p>
          </div>
        </div>

        {/* Ghế đã chọn */}
        <div className="mb-6">
          <h3 className="text-xl font-semibold border-b border-gray-600 pb-2 mb-4">Ghế đã chọn</h3>
        ...
        <div className="mb-6">
          {order.services?.length > 0 ? (
            <>
              <h3 className="text-xl font-semibold border-b border-gray-600 pb-2 mb-4">Dịch vụ</h3>
              <div className="space-y-2 mb-2 max-h-40 overflow-y-auto">
