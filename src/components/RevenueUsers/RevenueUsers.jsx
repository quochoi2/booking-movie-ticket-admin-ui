...
const RevenueUsers = () => {
  ...
  const formatCurrency = (amount) => {
    ...
    const numericAmount =
      typeof amount === 'string' ? parseInt(amount.replace(/^0+/, '')) : amount
      ...
      <Card className="overflow-hidden xl:col-span-3 border border-blue-gray-100 shadow-sm">
        ...
        >
          <div>
            ...
            >
              Tổng doanh thu: {formatCurrency(usersData.totalRevenue)} -{' '}
                      ...
                      <div className="flex items-center gap-4">
                        <Avatar
                          src={
                            user.image
                              ? user.image
                              : `https://ui-avatars.com/api/?name=${getInitials(user.fullname)}&background=random`
                          }
                          alt={user.fullname}
                          size="md"
