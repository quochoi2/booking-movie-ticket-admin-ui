  ...
  const ModalAuthorize = ({ open, onClose, onSubmit, userId, userPermissions = [] }) => {
            ...
            const normalizePermissions = (permissions) => {
              return permissions.map(p => {
                if (typeof p === 'string') {
                  ...
                  const found = response.data.data.find(perm => perm.name === p.name);
                  return found ? found.id : null;
                }
                return null;
              }).filter(id => id !== null);
    ...
    const handleTogglePermission = (permissionId) => () => {
      setSelectedPermissions(prev => {
        ...
        console.log("Current selected permissions:", 
          newSelected.map(id => {
